...
def analyze_contractions(data, window_size=5, exclude_fraction=1/4, future_pred_length=36000):
    ...
    plt.plot(data["start_time"], rolling_std_filled, label='Actual Rolling Std', color='blue')
    plt.plot(data["start_time"], rolling_std_pred, color='green', linewidth=2, label='Exponential Decay Fit')
